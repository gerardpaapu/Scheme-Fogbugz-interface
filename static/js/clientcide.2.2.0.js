...
//Contents: Core, Browser, Array, Function, Number, String, Hash, Event, Class, Class.Extras, Element, Element.Event, Element.Style, Element.Dimensions, Selectors, DomReady, JSON, Cookie, Swiff, Fx, Fx.CSS, Fx.Tween, Fx.Morph, Fx.Transitions, Request, Request.HTML, Request.JSON, More, Class.Binds, Chain.Wait, Array.Extras, Lang, Date.English.US, Date, Date.Extras, Hash.Extras, String.QueryString, URI, Class.Refactor, URI.Relative, Element.Forms, Elements.From, Element.Delegation, Request.Queue, Assets, Color, Group, Hash.Cookie, Log, Keyboard, Element.Measure, Element.Position, Class.Occlude, IframeShim, Mask, Tips, dbug, Popup

//This lib: http://www.clientcide.com/js/build.php?requireLibs[]=mootools-core&require[]=Class.Binds&require[]=Chain.Wait&require[]=Array.Extras&require[]=Date&require[]=Date.Extras&require[]=Hash.Extras&require[]=URI&require[]=URI.Relative&require[]=Element.Forms&require[]=Elements.From&require[]=Element.Delegation&require[]=Request.Queue&require[]=Assets&require[]=Color&require[]=Group&require[]=Hash.Cookie&require[]=Keyboard&require[]=Mask&require[]=Tips&require[]=dbug&require[]=Popup&compression=none
